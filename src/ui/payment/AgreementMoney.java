...
public class AgreementMoney extends JFrame {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgreementMoney frame = new AgreementMoney();
		...
		btnSucPay.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(rdbtn1.isSelected() && rdbtn2.isSelected() && rdbtn3.isSelected()) {
					...
					JOptionPane.showMessageDialog(null, "결제 약관에 동의를 진행해주세요!");
					pnMain.add(btnSucPay);

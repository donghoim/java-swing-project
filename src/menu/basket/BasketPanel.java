...
public class BasketPanel extends JPanel
{
	...
	public BasketPanel(MainMenuFrame frm, Product pr, int amount)
	{
		...
		lbPrName.setPreferredSize(new Dimension(200, 60));
		...
		pnOC.setMaximumSize(new Dimension(200, 60));
		pnOC.setPreferredSize(new Dimension(200, 60));
		add(pnOC, BorderLayout.CENTER);

		JPanel panel_1 = new JPanel();
		panel_1.setOpaque(true);
		panel_1.setBackground(Color.white);
		panel_1.setPreferredSize(new Dimension(200, 60));
		...
		lbPrice.setMaximumSize(new Dimension(120, 60));
		lbPrice.setMinimumSize(new Dimension(120, 60));
		lbPrice.setSize(new Dimension(120, 60));
		lbPrice.setSize(100, 60);
		...
		lbCancle.setSize(new Dimension(80, 60));
		lbCancle.setPreferredSize(new Dimension(80, 60));
